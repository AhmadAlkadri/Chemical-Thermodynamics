...
- **A phase count is never better than the stability test that produced it.**
  ...
  or two phases with no error. Measured: at 363 K one feed inside the ternary
  tie-triangle comes back a single liquid (validation Case V-2). (source:
...
- **Also open**
  ...
  - The stability trial set near a plait point: at 363 K one feed inside the ternary tie-triangle is missed and comes back a single liquid (validation Case V-2). This is a *stability* limitation, not a flash one.
