...
- Flash defaults: `FlashSettings(max_iter=100, tol=1e-8, damping=None, phase_detection="tangent-plane", stability_settings=None, post_split_stability=True, second_order=True, ssi_iterations=50, second_order_max_iter=100, second_order_tol=1e-12, max_phases=3)`. (source: src/chemthermo/flash/settings.py)
