...
from ..schemas import ComponentData, AntoineCoefficients, Parameter
...
class Component:
    ...
    def from_database(cls, name: str) -> "Component":
        ...
        try:
             ...
             raise NotImplementedError("Legacy data adapter not yet implemented. Run migration (Slice C).")
